...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2015 at 02:28 PM
...
(1, 'raza', 'raza@yahoo.com', '123456', 2, '', '', '', '');
...
(2, 2, 2, '1', '0000-00-00', 5000),
(3, 2, 3, '1', '0000-00-00', 120),
(4, 2, 1, '1', '0000-00-00', 50);
...
INSERT INTO `student_payments` (`id`, `student_id`, `sys_dues_id`, `created`, `amount`) VALUES
(12, 2, 1, '2015-08-12', 1000),
(13, 2, 2, '2015-08-12', 8000),
(14, 2, 3, '2015-08-12', 120),
(15, 2, 4, '2015-08-12', 6);
...
INSERT INTO `sys_dues` (`sys_dues_id`, `date`, `title`, `amount`) VALUES
...
--
ALTER TABLE `sys_dues`
  MODIFY `sys_dues_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
